                            ...
                            <div className="row">
                                <div className="col-12">
                                    <div className="form-group">
                                        <label htmlFor="productName" className="control-label">Nombre producto</label>
                                        <input type="text" name="productName" id="productName" className="form-control"required />
                                    </div>
                                </div>
                                <div className="col-4">
                                    <div className="form-group">
                                        <label htmlFor="MSU" className="control-label">Unidad minima de venta</label>
                                ...
                                <div className="col-4">
                                    <div className="form-group">
                                        <label htmlFor="stock" className="control-label">Stock disponible</label>
